...
1. Check [existing issues](https://github.com/Schengatto/gitsmith/issues) to avoid duplicates
2. Use the **Bug Report** issue template
3. Include your OS, Node.js version, and steps to reproduce

### Suggesting Features

1. Check [existing issues](https://github.com/Schengatto/gitsmith/issues) for similar suggestions
