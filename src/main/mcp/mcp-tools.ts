...
export function registerMcpTools(server: McpServer, git: GitService): void {
  ...
  server.registerTool("commit_details", {
  ...
  server.registerTool("commit_full_info", {
  ...
  server.registerTool("diff_staged", {
    title: "Staged Diff",
  ...
  server.registerTool("diff_commit", {
    title: "Commit Diff",
  ...
  server.registerTool("diff_commit_file", {
  ...
  server.registerTool("diff_commit_files", {
  ...
  server.registerTool("diff_range_files", {
    title: "Range Files",
  ...
  server.registerTool("diff_range_file", {
  ...
  server.registerTool("stash_list", {
    title: "List Stashes",
  ...
  server.registerTool("conflict_list", {
  ...
  server.registerTool("conflict_file_content", {
  ...
  server.registerTool("is_rebase_in_progress", {
    title: "Rebase Status",
  ...
  server.registerTool("tree_files", {
    title: "Tree Files",
  ...
  server.registerTool("discard", {
    ...
    return { content: [{ type: "text", text: `Discarded changes in ${paths.length} file(s)` }] };
  });
  ...
  server.registerTool("branch_create", {
    title: "Create Branch",
  ...
  server.registerTool("branch_delete", {
    title: "Delete Branch",
  ...
  server.registerTool("branch_checkout", {
  ...
  server.registerTool("merge_with_options", {
  ...
  server.registerTool("rebase_continue", {
  ...
  server.registerTool("rebase_abort", {
    title: "Abort Rebase",
  ...
  server.registerTool("cherry_pick", {
    title: "Cherry Pick",
  ...
  server.registerTool("stash_create", {
    title: "Create Stash",
  ...
  server.registerTool("stash_apply", {
    title: "Apply Stash",
  ...
  server.registerTool("stash_drop", {
    title: "Drop Stash",
  ...
  server.registerTool("fetch", {
    ...
    return { content: [{ type: "text", text: `Fetched from ${remote || "default remote"}` }] };
  });
  ...
  server.registerTool("conflict_resolve", {
  ...
  server.registerTool("conflict_save_merged", {
