    ...
    >
      {items.map((entry, i) => {
        ...
        if (entry.children && entry.children.length > 0) {
          return (
            <SubMenuItem key={entry.label} entry={entry} onClose={onClose} />
          );
        }
        return (
          <button
  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, opacity: 0.5 }}>
