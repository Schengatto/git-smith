          ...
          {TIMEFRAME_OPTIONS.map((opt) => (
            <button
              ...
              style={{
                ...
                backgroundColor: timeframe === opt.value ? "var(--accent)" : "var(--surface-1)",
                color: timeframe === opt.value ? "var(--text-on-color)" : "var(--text-secondary)",
                cursor: "pointer",
          ...
          >
            ...
            <tbody>
              {sorted.map((entry) => {
                ...
                const barWidth = Math.round((entry.commits / maxCommits) * 100);
                return (
                  <React.Fragment key={entry.authorEmail}>
                    ...
                    {isSelected && (
                      <tr>
                        <td colSpan={6} style={{ padding: 0, backgroundColor: "var(--surface-0)" }}>
