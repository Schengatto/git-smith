            ...
            <>
              ...
              <div style={{ display: "flex", gap: 14, marginBottom: 16 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {info.body && (
                    <div style={{ fontSize: 12, color: "var(--text-secondary)", whiteSpace: "pre-wrap", marginBottom: 6 }}>
                      {info.body}
                    </div>
                  )}
                  ...
                  {info.parentHashes.length > 0 && (
                    <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 4 }}>
                      Parent: {info.parentHashes.map((h) => (
                        <span key={h} style={{ fontFamily: "monospace", color: "var(--accent)", marginRight: 6 }}>
                          {h.slice(0, 10)}
                        </span>
                      ))}
                    </div>
...
const FileEntry: React.FC<{
  ...
  >
    ...
    {/* File path */}
    <span style={{ flex: 1, color: "var(--text-primary)", fontFamily: "monospace", fontSize: 11, minWidth: 0 }} className="truncate">
      {file.path}
    </span>
    {/* Stats */}
