...
export const InteractiveRebaseDialog: React.FC<Props> = ({
  open,
  onClose,
  onto,
  mode = "overlay",
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      await runGitOperation("Interactive Rebase", () =>
        window.electronAPI.branch.rebaseInteractive(onto, fullTodo)
      );
      if (mode === "overlay") {
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button
            ...
            style={{
              ...
              color:
                executing || entries.length === 0 ? "var(--text-muted)" : "var(--text-on-color)",
              fontSize: 12,
              fontWeight: 600,
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 0, flexShrink: 0 }}>
        <button
          ...
          style={{
            ...
            padding: 0,
            color: canMoveUp ? "var(--text-muted)" : "var(--surface-3)",
            lineHeight: 1,
          }}
        >
          <svg
        ...
        <button
          ...
          style={{
            ...
            padding: 0,
            color: canMoveDown ? "var(--text-muted)" : "var(--surface-3)",
            lineHeight: 1,
          }}
        >
          <svg
