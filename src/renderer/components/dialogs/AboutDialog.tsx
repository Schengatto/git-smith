...
const LogoSvg: React.FC<{ size?: number }> = ({ size = 80 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={size} height={size}>
    ...
    <path
      d="M 256 106 A 150 150 0 0 1 362 150"
      stroke="#89b4fa"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M 362 150 A 150 150 0 0 1 406 256"
      stroke="#a6e3a1"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M 406 256 A 150 150 0 0 1 362 362"
      stroke="#cba6f7"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M 362 362 A 150 150 0 0 1 256 406"
      stroke="#f9e2af"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M 256 406 A 150 150 0 0 1 150 362"
      stroke="#89b4fa"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M 150 362 A 150 150 0 0 1 106 256"
      stroke="#a6e3a1"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M 106 256 A 150 150 0 0 1 150 150"
      stroke="#fab387"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    />
    <path
      d="M 150 150 A 150 150 0 0 1 256 106"
      stroke="#cba6f7"
      strokeWidth="6"
      fill="none"
      strokeLinecap="round"
    ...
    <text
      ...
      textAnchor="middle"
      fill="#e0e4f7"
      fontFamily="'Segoe UI', 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif"
      fontSize="180"
      fontWeight="800"
      letterSpacing="-5"
    >
...
export const AboutDialog: React.FC<{ open: boolean; onClose: () => void }> = ({
  ...
  return (
    <ModalDialog open={open} title="About GitSmith" onClose={onClose} width={400}>
      <div
        style={{
          display: "flex",
