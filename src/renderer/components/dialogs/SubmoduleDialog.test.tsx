...
describe("SubmoduleDialog", () => {
  ...
  it("shows loading then submodule list", async () => {
    mockStatus.mockResolvedValueOnce([
      { name: "lib/core", path: "lib/core", url: "https://github.com/test/core.git", hash: "abc1234567890", branch: "main", status: "up-to-date" },
    ]);
  ...
  it("calls deinit on Deinit button click", async () => {
    mockStatus.mockResolvedValueOnce([
      { name: "lib/core", path: "lib/core", url: "", hash: "abc123", branch: "", status: "up-to-date" },
    ]);
