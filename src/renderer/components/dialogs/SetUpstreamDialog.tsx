  ...
  return (
    <ModalDialog open={open} title="Set Upstream & Push" onClose={onClose} width={460}>
      ...
      {force && (
        ...
        >
          Force pushing will <strong>overwrite the remote branch history</strong>. Any commits
          pushed by other collaborators that are not in your local branch will be permanently lost.
        </div>
      )}
