...
describe("MergeDialog", () => {
  ...
  it("shows log count input when Add log messages is checked", () => {
    ...
    fireEvent.click(
      screen.getByText("Add log messages").closest("label")!.querySelector("input")!
    );
  ...
  it("shows message textarea when Specify merge message is checked", () => {
    ...
    expect(
      screen.getByPlaceholderText("Enter merge commit message...")
    ).toBeInTheDocument();
  });
