...
vi.mock("./dialogs/CommitInfoWindow", () => ({
  CommitInfoWindow: (props: Record<string, unknown>) => (
    <div data-testid="commit-info-window" data-mode={props.mode as string}>
      CommitInfoWindow
    </div>
  ),
}));
vi.mock("./dialogs/StashDialog", () => ({
  StashDialog: (props: Record<string, unknown>) => (
    <div data-testid="stash-dialog" data-mode={props.mode as string}>
      StashDialog
    </div>
  ),
}));
vi.mock("./dialogs/SettingsDialog", () => ({
  SettingsDialog: (props: Record<string, unknown>) => (
    <div data-testid="settings-dialog" data-mode={props.mode as string}>
      SettingsDialog
    </div>
  ),
}));
vi.mock("./dialogs/InteractiveRebaseDialog", () => ({
  InteractiveRebaseDialog: (props: Record<string, unknown>) => (
    <div data-testid="interactive-rebase-dialog" data-mode={props.mode as string}>
