                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", gap: 6 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: newBranchName.trim() && !creatingBranch ? "var(--surface-0)" : "var(--text-muted)",
                        fontSize: 11,
                        fontWeight: 600,
                  ...
                  <div style={{ display: "flex" }}>
                    <button
                      ...
                      style={{
                        ...
                        color: canCommit ? "var(--surface-0)" : "var(--text-muted)",
                        fontSize: 12,
                        fontWeight: 600,
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "none",
                        borderLeft: `1px solid ${canCommit ? "rgba(0,0,0,0.2)" : "var(--border)"}`,
                        background: canCommit ? "var(--accent)" : "var(--surface-3)",
                        color: canCommit ? "var(--surface-0)" : "var(--text-muted)",
                        fontSize: 10,
                        cursor: "pointer",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span
            style={{
              ...
              color: count > 0 ? "var(--surface-0)" : "var(--text-muted)",
