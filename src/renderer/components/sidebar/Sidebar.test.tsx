...
vi.mock("../dialogs/BranchDialogs", () => ({
  ...
  DeleteBranchDialog: ({ open, branchName }: { open: boolean; branchName: string }) =>
    open ? <div data-testid="delete-branch-dialog">DeleteBranchDialog:{branchName}</div> : null,
  RenameBranchDialog: ({ open, branchName }: { open: boolean; branchName: string }) =>
    open ? <div data-testid="rename-branch-dialog">RenameBranchDialog:{branchName}</div> : null,
  MergeBranchDialog: ({ open, branchName }: { open: boolean; branchName: string }) =>
    open ? <div data-testid="merge-branch-dialog">MergeBranchDialog:{branchName}</div> : null,
